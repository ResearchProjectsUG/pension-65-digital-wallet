...
\begin{tablenotes}
\small
\item \textit{Notes:} \textit{Baseline} rows use local linear RDD (\texttt{rdrobust}) with triangular kernel and MSE-optimal bandwidth. Robust bias-corrected standard errors in parentheses. '---' indicates estimate unavailable.
\end{tablenotes}
\end{threeparttable}